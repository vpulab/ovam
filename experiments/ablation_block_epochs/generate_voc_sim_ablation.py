...
if __name__ == "__main__":
    ...
    for _, row in pbar:
        ...
        filename_img = output_folder / f"{classname}_{seed}_image.png"
        epochs_filename = output_folder / f"{classname}_{seed}_epochs.npy"
        a16_filename = output_folder / f"{classname}_{seed}_a16.npy"
        a32_filename = output_folder / f"{classname}_{seed}_a32.npy"
        a64_filename = output_folder / f"{classname}_{seed}_a64.npy"
        epochs_opt_filename = output_folder / f"{classname}_{seed}_epochs_opt.npy"
        a16_opt_filename = output_folder / f"{classname}_{seed}_a16_opt.npy"
        a32_opt_filename = output_folder / f"{classname}_{seed}_a32_opt.npy"
        a64_opt_filename = output_folder / f"{classname}_{seed}_a64_opt.npy"
        ...
        with torch.no_grad():
            ...
            emb = ca_extractor.encode_text(prompt, remove_special_tokens=False)
            heatmap = ca_extractor(emb)
            del emb
