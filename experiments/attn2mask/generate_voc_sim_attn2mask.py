...
def generate_filenames(classname, seed):
    ...
    filename_heatmap = output_folder / filename_template.format(
        model_name=model_name, classname=classname, seed=seed, kind="heatmap", ext="npy"
    )
...
if __name__ == "__main__":
    ...
    for _, row in pbar:
        ...
        with torch.no_grad():
            ...
            np.save(filename_heatmap_opt, optimized_heatmap.cpu().numpy())
